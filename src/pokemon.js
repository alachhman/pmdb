    ...
    pokemon: [
        ...
        ,
        {
            ...
            syncMove: {
                ...
                target: 'All allies',
                effect_tag: '-',
                description: 'Increases the user’s move gauge by the sync move’s current level. Sharply raises the Attack, Defense, Sp. Atk, Sp. Def, and accuracy of all allied sync pairs.'
            },
        ...
        ,
        {
            ...
            moves: [
                ...
                },
                {
                    ...
                    cost: '',
                    uses: 2,
                    effect: 'Raises the user’s Speed and Critical Rate. These stats are sharply raised when the user is in a sandstorm.',
                    unlock_requirements: []
                }
            ],
            syncMove: {
